...
import 'package:payzone/transactionhistory.dart';
            ...
            child: ListView(
              ...
              children: [
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                           ...
                           SizedBox(width: 18,),
                            Expanded(child: Text('abdullahomar@123.com',
                                style: TextStyle(
                                    fontSize: 24,
                                    fontFamily: 'Jost',
                                    fontWeight: FontWeight.bold
                ...
                ListTile(
                  ...
                  }, icon: Icon(Icons.history_rounded,color: Colors.lightBlueAccent,size: 35,weight: 20,)),
                  title: Text('Past Payments',style: TextStyle(fontFamily: 'Jost',fontSize: 30,fontWeight: FontWeight.bold),),
                ),
                ListTile(
                  tileColor: Colors.pinkAccent,
                  leading: IconButton(onPressed: (){
              ...
              child: Container(
                ...
                child: Card(
                  ...
                  child: GridView.count(
                    ...
                    mainAxisSpacing: 20,
                   children: [
                      buildGrid(Icons.send, "Send Money", context),
                      buildGrid(Icons.track_changes, "Analyze performance", context),
                      buildGrid(Icons.payment_rounded, "Pay Bills", context),
                      buildGrid(Icons.add_box, "Add Frequent Recipients", context),
                   ],
                  ),
...
Widget buildGrid(IconData icon,String label,BuildContext context){
